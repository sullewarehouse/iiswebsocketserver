...
__declspec(align(8)) struct IIS_WEB_SOCKET_SERVER_CLOSE_DATA
{
	USHORT status;
	CHAR reason[123];
	IIS_WEB_SOCKET_SERVER_CLOSE_DATA(IIS_WEB_SOCKET_CLOSE_STATUS server_status, CHAR* server_reason)
	{
